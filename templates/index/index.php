...
<body class="thrColFixHdr">
    ...
    <div class="main-content">
        <div class="slider">
            <div id="sliderFrame">
                <div id="slider">
                    <img src="images/front/01-homepage.jpg" />
                    <img src="images/front/02-homepage.jpg" />
                    <img src="images/front/03-homepage.jpg" />
                    <img src="images/front/04-homepage.jpg" />
                    <img src="images/front/05-homepage.jpg" />
                    <img src="images/front/06-homepage.jpg" />
                    <img src="images/front/07-homepage.jpg" />  
                </div>
            </div>
        </div><!-- /slider -->
    <div class="clear"></div>
  ...
  <script type="text/javascript" src="templates/index/js/image-slider.js"></script>

  <!-- Add JavaScript File (for main scripts) -->
  <script type="text/javascript" src="templates/index/js/main.js"></script>

  <!-- Add mousewheel plugin (this is optional) -->
	<script type="text/javascript" src="templates/index/fancybox/jquery.mousewheel-3.0.6.pack.js"></script>

	<!-- Add fancyBox main JS and CSS files -->
	<script type="text/javascript" src="templates/index/fancybox/jquery.fancybox.js?v=2.1.5"></script>

	<!-- Add Button helper (this is optional) -->
	<script type="text/javascript" src="templates/index/fancybox/helpers/jquery.fancybox-buttons.js"></script>

	<!-- Add Thumbnail helper (this is optional) -->
	<script type="text/javascript" src="templates/index/fancybox/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>

	<!-- Add Media helper (this is optional) -->
	<script type="text/javascript" src="templates/index/fancybox/helpers/jquery.fancybox-media.js?v=1.0.6"></script>

  <!-- Add Easing (for front page image slider) -->
	<script type="text/javascript" src="templates/index/js/jquery.easing.1.3.js"></script>
