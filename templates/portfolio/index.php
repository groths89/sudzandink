...
<body class="thrColFixHdr">
  ...
  <script type="text/javascript" src="templates/portfolio/js/image-slider.js"></script>

  <!-- Add JavaScript File (for main scripts) -->
  <script type="text/javascript" src="templates/portfolio/js/main.js"></script>

  <!-- Add mousewheel plugin (this is optional) -->
	<script type="text/javascript" src="templates/portfolio/fancybox/jquery.mousewheel-3.0.6.pack.js"></script>

	<!-- Add fancyBox main JS and CSS files -->
	<script type="text/javascript" src="templates/portfolio/fancybox/jquery.fancybox.js?v=2.1.5"></script>

	<!-- Add Button helper (this is optional) -->
	<script type="text/javascript" src="templates/portfolio/fancybox/helpers/jquery.fancybox-buttons.js"></script>

	<!-- Add Thumbnail helper (this is optional) -->
	<script type="text/javascript" src="templates/portfolio/fancybox/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>

	<!-- Add Media helper (this is optional) -->
	<script type="text/javascript" src="templates/portfolio/fancybox/helpers/jquery.fancybox-media.js?v=1.0.6"></script>

  <!-- Add Easing (for front page image slider) -->
	<script type="text/javascript" src="templates/portfolio/js/jquery.easing.1.3.js"></script>
